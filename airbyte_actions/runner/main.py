...
import dagger
from aircmd.models import Arguments
from clidantic import Parser

runner: Parser = Parser(name="runner")

class BuildArguments(Arguments):
    pass

class TestArguments(Arguments):
    pass

class PublishArguments(Arguments):
    pass

class DeployArguments(Arguments):
    pass

@runner.command(name="build")
async def build():
